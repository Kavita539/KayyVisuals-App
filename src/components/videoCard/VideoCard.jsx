...
return (
    <div className="video-card" onMouseOver={()=> setShowLaterButton(true)}
        onMouseLeave={() => setShowLaterButton(false)}
        >
        <button className={`video-card-watch-later-btn btn ${ showWatchLater ? "display-block" : "display-none" }`}>
        ...
        <div className="video-card-description-container">
            <div className="description-image-container">
                <img className="responsive-img rounded-img"
