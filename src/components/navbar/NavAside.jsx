...
return (
<>
    <div className={`nav-aside-background ${navAside ? "show-nav-background" : "" }`} onClick={()=>
        setNavAside(prevState => !prevState)}
        ></div>
    <div className={`nav-aside ${navAside ? "show-nav-aside" : "" }`}>
        ...
        <ul className="nav-aside-list styled-list">
            <li>
            ...
            <li>
                <NavLink to="/watch-later" className={({ isActive })=>
                    isActive ? "nav-aside-link active-side-link" : "nav-aside-link"
                    }
                    >
                    Watch later
