...
const WatchLaterVideosProvider = ({
    children
}) => {
            ...
            (async () => {
                try {
                    ...
                    const {
                        status,
                        data
                    } = await getWatchLaterServices(token);
    ...
    const addToWatchLater = async video => {
        try {
            ...
            const {
                status,
                data
            } = await addToWatchLaterServices(token, video);
    ...
    const removeFromWatchLater = async videoId => {
        try {
            ...
            const {
                status,
                data
            } = await removeFromWatchLaterServices(token, videoId);
